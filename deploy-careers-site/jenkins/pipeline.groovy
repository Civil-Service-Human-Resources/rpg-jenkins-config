pipeline {
    ...
    stages {
        ...
        stage('Build deployment zip') {
            steps {
                sh "ansible-playbook ./deploy-careers-site/ansible/package.yml --extra-vars 'user=${params.built_by}' --extra-vars 'base_dir=./deploy-careers-site' --skip-tags 'git_checkout'"
            }
        }
    }
}
